...
import { getCampaignNumber, createAndUploadFile, getSheetData, createExcelSheet, getAutoGeneratedBoundaryCodesHandler, getTargetSheetData, createBoundaryEntities } from "../api/genericApis";
import { logger } from "./logger";
import createAndSearch from "../config/createAndSearch";
import * as XLSX from 'xlsx';
import { findMapValue, getBoundaryRelationshipData, getLocalizedHeaders, getLocalizedMessagesHandler, modifyBoundaryData, modifyDataBasedOnDifferentTab, throwError } from "./genericUtils";
...
function getChildParentMap(modifiedBoundaryData: any) {
    ...
    console.log(childParentMap.get({ key: 'Posto Administrativo', value: 'NIHESSIUE' }));
...
function getCodeMappingsOfExistingBoundaryCodes(withBoundaryCode: any[]) {
    ...
    const mappingMap = new Map<{ key: string, value: string }, { key: string, value: string }>();
...
function getBoundaryTypeMap(boundaryData: any[], boundaryMap: Map<any, any>, localizationMap?: any) {
    const boundaryTypeMap: Map<{ key: string; value: string }, string> = new Map();
...
const autoGenerateBoundaryCodes = async (request: any, localizationMap?: any) => {
    ...
    console.log(boundaryDataForSheet,"sheeeeeeeeeeeeeeeeeettttttttttttttttttttt")
...
function modifyChildParentMap(childParentMap: Map<any, any>, boundaryMap: Map<any, any>): Map<string, string | null> {
    ...
    childParentMap.forEach((value, key) => {
        ...
        console.log(modifiedKey, "keyyyyyyyyyyyyyy")
        let modifiedValue = null;
        if (value != null) {
            modifiedValue = findMapValue(boundaryMap, value);
        }
        console.log(modifiedValue, "valueeeeeeeeeeeeeeeeeeee")
