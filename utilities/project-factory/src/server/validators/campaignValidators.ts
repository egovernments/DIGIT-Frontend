...
import Ajv from "ajv";
import { calculateKeyIndex, getDifferentDistrictTabs, getLocalizedHeaders, getLocalizedMessagesHandler, getMdmsDataBasedOnCampaignType, modifyTargetData, replicateRequest, throwError } from "../utils/genericUtils";
...
async function validateTargets(request: any, data: any[], lowestLevelHierarchy: any, errors: any[], localizationMap?: any) {
