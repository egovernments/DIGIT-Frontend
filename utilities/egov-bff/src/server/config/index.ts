...
const config = {
  ...
  host: {
    ...
    mdmsV2: process.env.EGOV_MDMS_V2_HOST|| "https://mukta-uat.digit.org/" || HOST || "http://localhost:8094/",
  ...
  paths: {
    ...
    mdmsV2_search: process.env.EGOV_MDMS_V2_SEARCH_ENDPOINT ||"/mdms-v2/v2/_search",
