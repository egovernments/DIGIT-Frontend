...
const CampaignBreadCrumb = ({ location, defaultPath }) => {
  ...
  const crumbs = [
    ...
    },
    {
      ...
      content: t(LOCALIZATION.SEARCH_CHECKLIST),
    ...
    {
      path: "",
      content: t(LOCALIZATION.CREATE_CHECKLIST),
    ...
    {
      path: "",
      content: t(LOCALIZATION.VIEW_CHECKLIST),
      show: pathVar.includes("checklist/view") ? true : false,
    },
    {
      path: "",
      content: t(LOCALIZATION.UPDATE_CHECKLIST),
    ...
    {
      path: "",
      content: t(LOCALIZATION.ADD_LOCALISATION_BREADCRUMB),
