...
const TagTemplate = ({ field, t, fieldTypeMasterData, }) => {
  ...
  return <Tag type={field?.properties?.tagType ? field?.properties?.tagType === "info" ? "monochrome" : field?.properties?.tagType : "monochrome"} label={tagLabel} stroke={true} icon={"Info"}/>;
};
