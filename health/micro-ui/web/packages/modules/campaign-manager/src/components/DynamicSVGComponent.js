...
const DynamicSVG = ({ ...props }) => {
  ...
  const url = `https://egov-dev-assets.s3.ap-south-1.amazonaws.com/hcm/${type}/${fieldType}.svg`; // TODO @Nabeel @jagan @bhavya scan through the app we should have s3 urls added in app directly
