      ...
      <div className="container">
        ...
        <TagComponent campaignName={campaignName} />  
          <Card className="setup-campaign-card">
            <HeaderComponent>{t(LOCALIZATION.HCM_CAMPAIGN_DATES_HEADER)}</HeaderComponent>
            <p className="dates-description">{t(LOCALIZATION.HCM_CAMPAIGN_DATES_DESCRIPTION)}</p>
          ...
          {showDateUpdateInfo && (
            <AlertCard
              ...
              variant="info"
              text={t(LOCALIZATION.HCM_UPDATE_DATE_INFO)}
