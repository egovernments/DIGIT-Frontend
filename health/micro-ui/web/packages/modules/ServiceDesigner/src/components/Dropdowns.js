...
import { TextInput, Tooltip, CheckBox, Button, FieldV1, CustomSVG } from "@egovernments/digit-ui-components";
      ...
      <div key={index} className="optioncheckboxwrapper" style={{ justifyContent: "space-between", height: "2rem" }}>
        <div style={{ display: "flex", position: "relative" }}
          ...
          <TextInput
            ...
            // value={field?.title || ""}
            value={title || ""}
            onChange={(ev) => updateOption({ value: ev.target.value.replace(/\./g, ''), id: index })}
        ...
        <div style={{ display: "flex", gap: "1rem", alignItems: "center" }}>
                ...
                >
                  ...
                  {showNestedChecklistTooltip && (
                    <span style={{
                      ...
                      {t("LINK_NESTED_CHECKLIST_TOOLTIP_2")}
                    </span>
                  )}
                </div>
              </div>
          ...
          {!dis && !disableDelete && (
            ...
            <Button
              ...
              title=""
              variation="link"
              style={{minWidth:"unset", marginTop:"-2px"}}
            />
          )}
        </div>
      </div>
