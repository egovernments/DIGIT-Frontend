    ...
    <React.Fragment>
      ...
      <LabelFieldPair className="app-preview-app-config-drawer-action-button">
        ...
        <TextInput
          ...
          onChange={(event) => {
            updateLocalization(
              currentCard?.actionLabel ? currentCard?.actionLabel : `${currentCard?.parent}_${currentCard?.name}_ACTION_BUTTON_LABEL`,
            ...
            dispatch({
              ...
              payload: {
                currentScreen: currentCard,
                actionLabel: currentCard?.actionLabel ? currentCard?.actionLabel : `${currentCard?.parent}_${currentCard?.name}_ACTION_BUTTON_LABEL`,
              },
            });
            return;
          }}
