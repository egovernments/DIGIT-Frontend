...
const PopInbox = () => {
  ...
  const {
    ...
    body: {
      PlanEmployeeAssignmentSearchCriteria: {
        ...
        tenantId: "mz",
        active: true,
        planConfigurationId: "6cb8bde7-138b-4c25-b13d-7a44c9b26407",
        role: ["POPULATION_DATA_APPROVER"],
        employeeId: ["13df46a3-6398-44b7-927e-62cf75c75bf4"],
      },
    },
    config: {
      enabled: true,
  ...
  return (
    <div className="pop-inbox-wrapper">
      <SearchJurisdiction boundaries={boundaries} jurisdiction={{
        "boundaryType": hierarchyLevel,
        "boundaryCodes": jurisdiction
      }} onSubmit={onSearch} onClear={onClear} />
      ...
      <div className="pop-inbox-wrapper-filter-table-wrapper">
        <InboxFilterWrapper
          ...
          defaultValue={selectedFilter !== '' && activeFilter ? { [Object.entries(activeFilter)?.[0]?.[0]]: Object.entries(activeFilter)?.[0]?.[1] } : null}
        ></InboxFilterWrapper>
        ...
        <div className={"pop-inbox-table-wrapper"}>
          ...
          <Card type={"primary"}>
            {villagesSlected !== 0 && <div className="selection-state-wrapper">
