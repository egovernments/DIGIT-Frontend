...
import { ArrowBack, ArrowForward, ArrowToFirst, ArrowToLast, SortDown, SortUp, DoubleTickIcon } from "@egovernments/digit-ui-components";
...
const IndeterminateCheckbox = forwardRef(     //!checkbox state
...
const Table = ({
  ...
  console.log("getCellProps",getCellProps);
