...
// const STORAGE_KEY = "paymentSetupCache_v1"; // change key to invalidate previous caches
...
//   // Read initial cache from sessionStorage (if available)
...
//   // State Management - initialize from session storage (if present)
//   const [selectedCampaign, setSelectedCampaign] = useState(initialCache.selectedCampaign || null);
//   const [billingCycle, setBillingCycle] = useState(initialCache.billingCycle || null);
//   const [customDays, setCustomDays] = useState(initialCache.customDays || "");
//   const [projectOptions, setProjectOptions] = useState([]);
//   const [skillsData, setSkillsData] = useState(initialCache.skillsData || null);
//   const [loadingSkills, setLoadingSkills] = useState(false);
//   const [wagePayload, setWagePayload] = useState(initialCache.wagePayload || null);
//   const [billingConfigData, setBillingConfigData] = useState(initialCache.billingConfigData || null);

//   const [edit, setEdit] = useState(initialCache.edit || false);
//   const [update, setUpdate] = useState(initialCache.update || false);

//   // for opening the popup screen
//   const [popup, setPopUp] = useState(false);
//   const [loading, setLoading] = useState(false);
//   const [tableError, setTableError] = useState(false);
//   const [isFormModified, setIsFormModified] = useState(initialCache.isFormModified || false);
...
//     }
//   }, [selectedCampaign, billingCycle, customDays, skillsData, edit, update, wagePayload, billingConfigData, isFormModified]);

//   // Function to clear storage (can be wired to a button if needed)
