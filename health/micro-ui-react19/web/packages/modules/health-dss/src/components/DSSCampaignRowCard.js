...
const getActionButtons = (rowData, tabData, navigate, t, boundaryCodeResponse, campaignData) => {
  const actions = {};
...
const DSSCampaignRowCard = ({ key, rowData, tabData }) => {
  ...
  const actionButtons = getActionButtons(rowData, tabData, navigate, t, boundaryCodeResponse, campaignData);
