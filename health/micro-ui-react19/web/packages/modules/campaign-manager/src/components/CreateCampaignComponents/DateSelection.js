  ...
  return (
    <Card>
      <HeaderComponent styles={{}} className="digit-header-content digit-card-section-header titleStyle date-selection ">
        {t(I18N_KEYS.CAMPAIGN_CREATE.HCM_CAMPAIGN_DATES_HEADER)}
      </HeaderComponent>
      <p className="dates-description digit-header-content SubHeadingClass">{t(I18N_KEYS.CAMPAIGN_CREATE.HCM_CAMPAIGN_DATES_DESC)}</p>
      <LabelFieldPair className={"boldLabel"} style={{borderRadius:"12px"}} vertical={false} removeMargin={false}>
        <div className="digit-header-content label " style={{ display: "flex", alignItems: "center", marginTop: "0.5rem" }}>
          <div>{t(I18N_KEYS.CAMPAIGN_CREATE.HCM_CAMPAIGN_DATES)}</div>
