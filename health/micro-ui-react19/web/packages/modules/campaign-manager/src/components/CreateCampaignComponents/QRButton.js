...
const QRButton = ({setShowQRPopUp}) => {
  ...
  return (
    <PopUp
          type={"default"}
          heading={t(I18N_KEYS.COMPONENTS.ES_APP_QR)}
          description={t(I18N_KEYS.COMPONENTS.ES_APP_QR_DESC)}
          className={"QR-pop-up"}
          ...
          footerChildren={[
            <Button
              ...
              size={"large"}
              variation={"primary"}
              label={t(I18N_KEYS.COMPONENTS.ES_CAMPAIGN_CLOSE)}
              title={t(I18N_KEYS.COMPONENTS.ES_CAMPAIGN_CLOSE)}
              onClick={() => {
