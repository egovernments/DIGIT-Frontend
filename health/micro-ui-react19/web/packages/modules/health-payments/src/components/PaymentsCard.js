...
const PaymentsCard = () => {
  console.log("PaymentsCard RENDERING");
  console.log("Digit.Utils.didEmployeeHasAtleastOneRole:", typeof Digit?.Utils?.didEmployeeHasAtleastOneRole);
  const allRoles = Object.values(ROLES).flatMap((e) => e);
  console.log("Required roles:", allRoles);
  console.log("Role check result:", Digit?.Utils?.didEmployeeHasAtleastOneRole?.(allRoles));
