...
import { Card, HeaderComponent, Button, Dropdown, Toast, PopUp, Footer } from "@egovernments/digit-ui-components";
...
const UploadAndFetchBillsCard = () => {
  ...
  const handleConfirm = () => {
    ...
    navigate(`/${window.contextPath}/employee/payments/verify-and-generate-payments`, { state: { selectedBillIds } });
  };
