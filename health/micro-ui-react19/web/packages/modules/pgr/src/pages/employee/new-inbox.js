...
// InboxV2 — uses InboxSearchComposer with config-driven search + filter + table layout
// React 19: same logic as React 17 but no class components; useLocation already v6 compatible
const InboxV2 = () => {
  ...
  const updatedConfig = useMemo(
    () =>
      Digit.Utils.preProcessMDMSConfigInboxSearch(t, pageConfig, "sections.filter.uiConfig.fields", {
        updateDependent: [
          { key: "locality", value: wardsAndLocalities ? [...wardsAndLocalities] : [] },
          { key: "serviceCode", value: serviceDefs ? [...serviceDefs] : [] },
        ],
      }),
