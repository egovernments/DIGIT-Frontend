...
// Each route entry: component to render, texts shown, nextStep key (null = final submit step)
export const config = {
  routes: {
    "complaint-type": {
    ...
    pincode: {
      ...
      inputs: [{ label: "CORE_COMMON_PINCODE", type: "text", name: "pincode", validation: { minLength: 6, maxLength: 7 }, error: "CORE_COMMON_PINCODE_INVALID" }],
      nextStep: "address",
    },
    address: {
    ...
    landmark: {
      ...
      inputs: [{ label: "CS_ADDCOMPLAINT_LANDMARK", type: "textarea", name: "landmark" }],
    ...
    "additional-details": {
      ...
      inputs: [{ label: "CS_ADDCOMPLAINT_ADDITIONAL_DETAILS", type: "textarea", name: "details" }],
      nextStep: null, // null means submit on this step
    },
  },
