...
export default {
  title: "Molecules/Card/PrimaryCard",
  component: Card,
  argTypes: {
    className: {
      control: "text",
...
export const PrimaryEmptyCard = Template.bind({});
PrimaryEmptyCard.args = {
  type: "primary",
};

export const PrimaryCardWithElements = () => (
  <Card type={"primary"}>
    <div>
...
export const PrimaryCardWithTextBlock = () => (
  <Card type={"primary"}>
    <TextBlock
      caption="Caption"
      captionClassName=""
...
export const PrimarySearchCard = () => (
  <Card type={"primary"} variant="search">
