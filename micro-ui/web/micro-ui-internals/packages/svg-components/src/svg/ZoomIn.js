...
export const ZoomIn = ({ className, height = "24", width = "24", style = {}, fill = COLOR_FILL, onClick = null }) => {
  return (
    <svg width={width} height={height} className={className} onClick={onClick} style={style} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      <g clipPath="url(#clip0_105_1246)">
        <path
          ...
          fill={fill}
        />
        <path d="M12 10H10V12H9V10H7V9H9V7H10V9H12V10Z" fill={fill} />
      </g>
      <defs>
