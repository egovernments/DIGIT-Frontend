...
export const Calculate = ({ className, width = "18", height = "18", style = {}, fill = "#E65006", onClick = null }) => {
    return (
        <svg
            width={width}
            height={height}
