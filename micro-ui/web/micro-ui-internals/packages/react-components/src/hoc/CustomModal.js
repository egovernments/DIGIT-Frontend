    ...
    <PopUp>
      <div className="popup-module" style={popupStyles}>
        ...
        <div className="popup-module-main" style={popupModuleMianStyles ? popupModuleMianStyles : {}}>
          {children}
          <div className="popup-module-action-bar" style={moduleActionBarStyle(isOBPSFlow, mobileView, popupModuleActionBarStyles)}>
...
const moduleActionBarStyle = (isOBPSFlow, mobileView, popupModuleActionBarStyles) => {
  return isOBPSFlow
    ? !mobileView
      ? { marginRight: "18px" }
