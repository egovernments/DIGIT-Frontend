...
const PTIcon = ({ className, styles, height, width, fill }) => (
  <svg width={width ? width : "40"} height={height ? height : "40"} style={{ ...styles }} viewBox="0 0 34 30" fill={fill ? fill : "#ffffff"} className={className} xmlns="http://www.w3.org/2000/svg" >
...
const DashboardIcon = ({ className = "", fill, style = {} }) => (
  <svg width="24" height="24" className={className} style={style} viewBox="0 0 24 24" fill={fill ? fill : "none"} xmlns="http://www.w3.org/2000/svg">
