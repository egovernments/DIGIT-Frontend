...
const TqmSearch = () => {
    ...
    //     }
    // );
    const data = tqmSearchConfigUlbAdmin?.tqmSearchConfig?.[0]
  
   // const data =
    //tqmSearchConfigUlbAdmin?.tqmSearchConfig?.[0]
   //tqmSearchConfigPlantOperator?.tqmSearchConfig?.[0]

    
    //[isPlantOperatorLoggedIn, isUlbAdminLoggedIn]
    //);
