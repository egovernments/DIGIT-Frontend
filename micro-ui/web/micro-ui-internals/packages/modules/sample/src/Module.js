...
const SampleModule = ({ stateCode, userType, tenants }) => {
  const moduleCode = ["sample","mdms","schema"];
...
const componentsToRegister = {
  ...
  SampleCard,
  DigitJSONForm,
  DSSCard: null, // TO HIDE THE DSS CARD IN HOME SCREEN as per sample
  // HRMSCard // Overridden the HRMS card as per sample
};
