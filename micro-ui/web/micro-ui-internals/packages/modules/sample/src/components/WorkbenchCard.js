  ...
  let links = [
    {
      ...
      link: `/${window?.contextPath}/employee/sample/manage-master-data`,
      roles: ROLES.MDMS,
    },
    {
      label: t("ACTION_TEST_LOCALISATION"),
      link: `/${window?.contextPath}/employee/sample/localisation-search`,
      roles: ROLES.LOCALISATION,
    },
    // {
    //   label: t("Sample Create master"),
    //   link: `/${window?.contextPath}/employee/sample/mdms-add-v2?moduleName=common-masters&masterName=Sample`,
    //   roles: ROLES.MDMS,
    // },
    // {
    //   label: t("Sample Search master"),
    //   link: `/${window?.contextPath}/employee/sample/mdms-search-v2?masterName=common-masters&moduleName=Sample`,
    //   roles: ROLES.MDMS,
    // },
  ];
