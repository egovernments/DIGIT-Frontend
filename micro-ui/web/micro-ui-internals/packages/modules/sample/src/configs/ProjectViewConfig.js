        ...
        sections: [
          {
            ...
            values: [
                {
                    key: "PROJECT_ID",
                    value: project?.Projects?.[0]?.id || "NA",
                  },
                  {
                    key: "TENANT_ID",
                    value: project?.Projects?.[0]?.tenantId || "NA",
                  },
                  {
                    key: "PROGRAM_CODE",
                    value: project?.Projects?.[0]?.programCode || "NA",
                  },
                  {
                    key: "AGENCY_ID",
                    value: project?.Projects?.[0]?.agencyId || "NA",
                  },
                  {
                    key: "PROJECT_CODE",
                    value: project?.Projects?.[0]?.projectCode || "NA",
                  },
                  {
                    key: "PROJECT_IDENTIFIER",
                    value: project?.Projects?.[0]?.projectId || "NA",
                  },
                  {
                    key: "NAME",
                    value: project?.Projects?.[0]?.name || "NA",
                  },
                  {
                    key: "DESCRIPTION",
                    value: project?.Projects?.[0]?.description || "NA",
                  },
                  {
                    key: "STATUS_CODE",
                    value: project?.Projects?.[0]?.status?.statusCode || "NA",
                  },
                  {
                    key: "STATUS_MESSAGE",
                    value: project?.Projects?.[0]?.status?.statusMessage || "NA",
                  },
              // {
