        ...
        sections: [
          {
            ...
            values: [
                {
                    key: "ESTIMATE_ID",
                    value: estimate?.Estimates?.[0]?.id || "NA",
                  },
                  {
                    key: "TENANT_ID",
                    value: estimate?.Estimates?.[0]?.tenantId || "NA",
                  },
                  {
                    key: "PROGRAM_CODE",
                    value: estimate?.Estimates?.[0]?.programCode || "NA",
                  },
                  {
                    key: "PROJECT_CODE",
                    value: estimate?.Estimates?.[0]?.projectCode || "NA",
                  },
                  {
                    key: "ESTIMATE_IDENTIFIER",
                    value: estimate?.Estimates?.[0]?.estimateId || "NA",
                  },
                  {
                    key: "DESCRIPTION",
                    value: estimate?.Estimates?.[0]?.description || "NA",
                  },
                  {
                    key: "NET_AMOUNT",
                    value: estimate?.Estimates?.[0]?.netAmount || "NA",
                  },
                  {
                    key: "GROSS_AMOUNT",
                    value: estimate?.Estimates?.[0]?.grossAmount || "NA",
                  },
                  {
                    key: "STATUS_CODE",
                    value: estimate?.Estimates?.[0]?.status?.statusCode || "NA",
                  },
                  {
                    key: "STATUS_MESSAGE",
                    value: estimate?.Estimates?.[0]?.status?.statusMessage || "NA",
                  },
