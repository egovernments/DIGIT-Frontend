        ...
        sections: [
          {
            ...
            values: [
                {
                    key: "SANCTION_ID",
                    value: sanction?.Sanctions?.[0]?.id || "NA",
                  },
                  {
                    key: "TENANT_ID",
                    value: sanction?.Sanctions?.[0]?.tenantId || "NA",
                  },
                  {
                    key: "PROGRAM_CODE",
                    value: sanction?.Sanctions?.[0]?.programCode || "NA",
                  },
                  {
                    key: "PROJECT_CODE",
                    value: sanction?.Sanctions?.[0]?.projectCode || "NA",
                  },
                  {
                    key: "SANCTION_IDENTIFIER",
                    value: sanction?.Sanctions?.[0]?.sanctionId || "NA",
                  },
                  {
                    key: "NET_AMOUNT",
                    value: sanction?.Sanctions?.[0]?.netAmount || "NA",
                  },
                  {
                    key: "GROSS_AMOUNT",
                    value: sanction?.Sanctions?.[0]?.grossAmount || "NA",
                  },
                  {
                    key: "AVAILABLE_AMOUNT",
                    value: sanction?.Sanctions?.[0]?.availableAmount || "NA",
                  },
                  {
                    key: "STATUS_CODE",
                    value: sanction?.Sanctions?.[0]?.status?.statusCode || "NA",
                  },
                  {
                    key: "STATUS_MESSAGE",
                    value: sanction?.Sanctions?.[0]?.status?.statusMessage || "NA",
                  },
              // {
