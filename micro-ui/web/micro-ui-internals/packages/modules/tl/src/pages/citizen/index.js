...
import TLApplicationDetails from "./Applications/ApplicationDetails";
import TLMyApplications from "./Applications";
        ...
        <span className={"tl-citizen"}>
            <Switch>
              ...
              /* style={{ position: "fixed", top: "55px" }} */ isCommonPTPropertyScreen={isCommonPTPropertyScreen}
                    ...
                    <PrivateRoute path={`${path}/tradelicence/application/:id/:tenantId`} component={TLApplicationDetails} />
