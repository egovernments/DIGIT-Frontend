...
import TLWFApplicationTimeline from "../../../components/TLWFApplicationTimeline";
import TLDocument from "../../../components/TLDocuments";
                        ...
                        <div key={index} className="employee-data-table">
                            ...
                            {!(PTData?.Properties && PTData?.Properties.length > 0) && (
                                <Row
                                    ...
                                    text={`${application?.tradeLicenseDetail?.address?.doorNo?.trim() ? `${application?.tradeLicenseDetail?.address?.doorNo?.trim()}, ` : ""
                                        } ${application?.tradeLicenseDetail?.address?.street?.trim() ? `${application?.tradeLicenseDetail?.address?.street?.trim()}, ` : ""
                                        }${t(application?.tradeLicenseDetail?.address?.locality?.name)}, ${t(application?.tradeLicenseDetail?.address?.city)} ${application?.tradeLicenseDetail?.address?.pincode?.trim() ? `,${application?.tradeLicenseDetail?.address?.pincode?.trim()}` : ""
                                        }`}
                                    textStyle={{ wordBreak: "break-word" }}
                                // textStyle={{ whiteSpace: "pre-wrap", width: "70%", wordBreak:"break-word" }}
                                />
