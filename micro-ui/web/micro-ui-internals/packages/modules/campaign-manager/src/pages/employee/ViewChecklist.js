    ...
    <div style={{ marginBottom: "2rem" }}>
      ...
      {!isLoading && (
        <FormComposerV2
          ...
          onSubmit={() => {
            navigate(
              `/${window.contextPath}/employee/campaign/checklist/update?campaignName=${campaignName}&role=${role}&checklistType=${checklistType}&projectType=${projectType}&campaignId=${campaignId}`
            );
          }}
