...
cd "$BASEDIR/packages/modules/open-payment" &&   rm -rf dist && yarn&& npm publish --access public

msg "Building and publishing Utilities module"
cd "$BASEDIR/packages/modules/sandbox" &&   rm -rf dist && yarn&& npm publish --access public