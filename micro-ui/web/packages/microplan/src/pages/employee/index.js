...
import { useMyContext,ProviderContext } from "../../utils/context";
...
const App = ({ path }) => {
  ...
  const { isLoading } = Digit.Hooks.core.useLocalization({
    params:{
      ...
      module: 'rainmaker-microplanning,rainmaker-campaignmanager',
    ...
    <React.Fragment>
      ...
      <Switch>
        <AppContainer className="workbench">
          ...
          <PrivateRoute path={`${path}/sample`} component={() => <div>Sample Screen in Microplanning module</div>} />
