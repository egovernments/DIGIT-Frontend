...
const MaintainanceIcon = ({ className = "", fill = "", style = {} }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="34" height="36" viewBox="0 0 34 36" fill="none" className={className} style={style}>
    <path
      d="M33.1151 29.2835L24.2818 20.4502H22.6318L18.3984 24.6835V26.3335L27.2318 35.1669C27.8818 35.8169 28.9318 35.8169 29.5818 35.1669L33.1151 31.6335C33.7651 31.0002 33.7651 29.9335 33.1151 29.2835Z"
      fill="#F47738"
    />
    <path
      d="M25.8987 15.9837L28.2487 13.6337L31.782 17.167C33.732 15.217 33.732 12.0503 31.782 10.1003L25.882 4.20033L23.532 6.55033V1.85033L22.3654 0.666992L16.4654 6.56699L17.6487 7.75032H22.3654L20.0154 10.1003L21.782 11.867L16.9654 16.6837L10.082 9.80032V7.43366L5.0487 2.40033L0.332031 7.11699L5.38203 12.167H7.73203L14.6154 19.0503L13.1987 20.467H9.66536L0.832031 29.3003C0.182031 29.9503 0.182031 31.0003 0.832031 31.6503L4.36536 35.1837C5.01536 35.8337 6.06536 35.8337 6.71536 35.1837L15.5487 26.3503V22.817L24.132 14.2337L25.8987 15.9837Z"
      fill="#F47738"
    />
  </svg>
);

const IssueIcon = ({ className = "", fill = "", style = {} }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 40 40" fill="none" className={className} style={style}>
    <g clip-path="url(#clip0_52342_113187)">
      <path
        d="M33.332 3.33301H6.66536C4.83203 3.33301 3.3487 4.83301 3.3487 6.66634L3.33203 36.6663L9.9987 29.9997H33.332C35.1654 29.9997 36.6654 28.4997 36.6654 26.6663V6.66634C36.6654 4.83301 35.1654 3.33301 33.332 3.33301ZM21.6654 18.333H18.332V8.33301H21.6654V18.333ZM21.6654 24.9997H18.332V21.6663H21.6654V24.9997Z"
        fill="#F47738"
      />
    </g>
    <defs>
      <clipPath id="clip0_52342_113187">
        <rect width="40" height="40" fill="white" />
      </clipPath>
    </defs>
  </svg>
...
const ViewReportsIcon = ({ className = "", fill = "", style = {} }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="38" height="29" viewBox="0 0 38 29" fill="none" className={className} style={style}>
    <path
      d="M34.0013 1.33333C32.1513 0.75 30.118 0.5 28.168 0.5C24.918 0.5 21.418 1.16667 19.0013 3C16.5846 1.16667 13.0846 0.5 9.83463 0.5C6.58463 0.5 3.08464 1.16667 0.667969 3V27.4167C0.667969 27.8333 1.08464 28.25 1.5013 28.25C1.66797 28.25 1.7513 28.1667 1.91797 28.1667C4.16797 27.0833 7.41797 26.3333 9.83463 26.3333C13.0846 26.3333 16.5846 27 19.0013 28.8333C21.2513 27.4167 25.3346 26.3333 28.168 26.3333C30.918 26.3333 33.7513 26.8333 36.0846 28.0833C36.2513 28.1667 36.3346 28.1667 36.5013 28.1667C36.918 28.1667 37.3346 27.75 37.3346 27.3333V3C36.3346 2.25 35.2513 1.75 34.0013 1.33333ZM34.0013 23.8333C32.168 23.25 30.168 23 28.168 23C25.3346 23 21.2513 24.0833 19.0013 25.5V6.33333C21.2513 4.91667 25.3346 3.83333 28.168 3.83333C30.168 3.83333 32.168 4.08333 34.0013 4.66667V23.8333Z"
      fill="#F47738"
    />
    <path
      d="M28.168 10.5C29.6346 10.5 31.0513 10.65 32.3346 10.9333V8.4C31.018 8.15 29.6013 8 28.168 8C25.3346 8 22.768 8.48333 20.668 9.38333V12.15C22.5513 11.0833 25.168 10.5 28.168 10.5Z"
      fill="#F47738"
    />
    <path
      d="M20.668 13.8169V16.5836C22.5513 15.5169 25.168 14.9336 28.168 14.9336C29.6346 14.9336 31.0513 15.0836 32.3346 15.3669V12.8336C31.018 12.5836 29.6013 12.4336 28.168 12.4336C25.3346 12.4336 22.768 12.9336 20.668 13.8169Z"
      fill="#F47738"
    />
    <path
      d="M28.168 16.8838C25.3346 16.8838 22.768 17.3671 20.668 18.2671V21.0338C22.5513 19.9671 25.168 19.3838 28.168 19.3838C29.6346 19.3838 31.0513 19.5338 32.3346 19.8171V17.2838C31.018 17.0171 29.6013 16.8838 28.168 16.8838Z"
      fill="#F47738"
    />
  </svg>
);
...
const VehicleLogIcon = ({ className = "", fill = "#F47738", style = {} }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="40" height="22" viewBox="0 0 40 22" fill="none" className={className} style={style}>
    <path d="M1.61732 15.4932H7.53019C6.99893 16.1978 6.68339 17.0608 6.68339 18.0127H2.77469L1.61719 17.2083L1.61732 15.4932Z" fill={fill} />
    <path
      d="M19.9955 0.899414H5.75336C2.5899 0.899414 0 3.48919 0 6.6566V8.77374C0 11.9414 2.58978 14.5309 5.75336 14.5309H19.9951C23.1585 14.5309 25.7442 11.9411 25.7442 8.77374V6.6566C25.7445 3.48898 23.1588 0.899414 19.9955 0.899414Z"
      fill={fill}
    />
    <path
      d="M10.894 14.9307C9.18665 14.9307 7.80078 16.3144 7.80078 18.0134C7.80078 19.7233 9.18698 21.1018 10.894 21.1018C12.5957 21.1018 13.9768 19.7238 13.9768 18.0134C13.9766 16.314 12.5957 14.9307 10.894 14.9307ZM10.894 19.6964C9.95984 19.6964 9.20238 18.9446 9.20238 18.0128C9.20238 17.0868 9.95984 16.3349 10.894 16.3349C11.82 16.3349 12.5777 17.0868 12.5777 18.0128C12.5775 18.9444 11.82 19.6964 10.894 19.6964Z"
      fill={fill}
    />
    <path
      d="M32.4269 14.9297C30.7182 14.9297 29.332 16.3156 29.332 18.0125C29.332 19.7215 30.7182 21.0992 32.4269 21.0992C34.1278 21.0992 35.514 19.7215 35.514 18.0125C35.5137 16.3156 34.128 14.9297 32.4269 14.9297ZM32.4269 19.6971C31.4976 19.6971 30.7381 18.9456 30.7381 18.0123C30.7381 17.0871 31.4977 16.3357 32.4269 16.3357C33.3521 16.3357 34.1076 17.0872 34.1076 18.0123C34.1077 18.9456 33.352 19.6971 32.4269 19.6971Z"
      fill={fill}
    />
    <path
      d="M39.5944 9.31985L37.3564 2.58822L33.8289 0.899414H26.791V15.4928H14.25C14.7793 16.1999 15.0985 17.0605 15.0985 18.0179H28.213C28.213 15.6948 30.0998 13.8161 32.4269 13.8161C34.0592 13.8161 35.4693 14.7494 36.1682 16.115C36.4188 16.5958 36.5807 17.1413 36.613 17.7231C36.617 17.8161 36.6332 17.913 36.6332 18.0181L39.9983 18.0179V10.9999L39.5944 9.31985ZM28.7745 9.31985V4.26943H36.2333L37.9139 9.31985H28.7745Z"
      fill={fill}
    />
  </svg>
);
...
const ArrowUpward = () => (
  <svg width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path
      d="M11.332 5.99967L10.392 5.05967L6.66536 8.77967L6.66537 0.666341L5.33203 0.666341L5.33203 8.77967L1.61203 5.05301L0.665366 5.99967L5.9987 11.333L11.332 5.99967Z"
      fill={fill}
    />
  </svg>
);

const ArrowDownward = ({ fill = "#D4351C" }) => (
  <svg width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path
      d="M11.332 5.99967L10.392 5.05967L6.66536 8.77967L6.66537 0.666341L5.33203 0.666341L5.33203 8.77967L1.61203 5.05301L0.665366 5.99967L5.9987 11.333L11.332 5.99967Z"
      fill={fill}
...
const DocumentRect = ({ styles = {}, className, fill = "#D4351C" }) => (
