...
import { RadioButtons, FormComposer, Dropdown, CardSectionHeader, Loader, Toast, Card, Header } from "@digit-ui/digit-ui-react-components";
...
export const CollectPayment = (props) => {
  ...
  const onSubmit = async (data) => {
    ...
    //dont be dependent on fsm hooks, pls add generelized hook call
