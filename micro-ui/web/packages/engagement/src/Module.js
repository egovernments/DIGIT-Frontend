...
const EventsBreadCrumb = ({ location }) => {
  ...
  const crumbs = [
    ...
    },
    {
      ...
      content: t("NEW_DOCUMENT_TEXT"),
      show: location.pathname.includes("/documents/inbox/new-doc")
        ? true
        : false,
    },
    {
    ...
    },
    {
      ...
      content: t("ES_EVENT_NEW_EVENT_RESPONSE"),
      show: location.pathname.includes("/documents/delete-response")
        ? true
        : false,
    },
    {
      ...
      content: t("ES_EVENT_NEW_EVENT_RESPONSE"),
      show: location.pathname.includes("/documents/update-response")
        ? true
        : false,
    },
    {
      ...
      show: location.pathname.includes("/documents/inbox/details")
        ? true
        : false,
    },
    {
      ...
      show: location.pathname.includes("/documents/inbox/update")
        ? true
        : false,
    },
    {
    ...
    },
    {
      ...
      show: location.pathname.includes("/messages/inbox/details")
        ? true
        : false,
    },
    {
    ...
    },
    {
      ...
      content: t("ES_EVENT_NEW_EVENT_RESPONSE"),
      show: location.pathname.includes("/messages/response?update=true")
        ? true
        : false,
    },
    {
      ...
      content: t("ES_EVENT_NEW_EVENT_RESPONSE"),
      show: location.pathname.includes("/messages/response?delete=true")
        ? true
        : false,
    },
    {
    ...
    },
    {
      ...
      content: t("ES_EVENT_NEW_EVENT_RESPONSE"),
      show: location.pathname.includes("/engagement/survey/create-response")
        ? true
        : false,
    },
  ];
...
export const EmployeeApp = ({ path, url, userType, tenants }) => {
...
const EngagementModule = ({ stateCode, userType, tenants }) => {
  ...
  if (userType === "citizen") {
    return (
      <CitizenApp path={path} url={url} userType={userType} tenants={tenants} />
    );
  } else {
    return (
      <EmployeeApp
